            ...
            <div className="currency-details-wrap">
                <div className="currency-details-left">
                    <div className="cdl-head">
                        {
                            ...
                            :
                            <div className="cdl-title">
                                <CoinImgComponent url={"/boop-img.jpg"/*{coinDets?.image?.small}*/} />
                                {/* {coinDets?.name} */}
                                Just Four Letters
                                {/* <span>{coinDets?.symbol}</span> */}
                                <span>$BOOP</span>
                                {/* <div className="cdl-rank">#{coinDets?.market_cap_rank}</div> */}
                                <div className="cdl-rank">#0</div>
                            </div>
                        }
                        ...
                        <div className="cdl-metadata-tab">
                            ...
                            <div className="cdlm-body">
                                ...
                                // coinDets && coinDets?.links?.homepage &&
                                    <a href={"https://boopbase.com"} className="cdlm-body-item btn-bg">
                            ...
                            <div className="cdl-metadata-tab">
                                ...
                                <div className="cdlm-body">
                                    <div className="cdlm-body-item btn-bg">
                                        ...
                                        0xAf1f...04332c
                                        <div onClick={()=>{copyText("0xAf1f7E0633ce0D334cFdf859dA45c6Fb4504332c")}}>
                    ...
                    <div className="usd-converter-wrap btn-bg">
                        <div>
                            <span>BOOP{/*{coinDets && coinDets?.symbol.toUpperCase()}*/}</span> <input inputMode="numeric" onChange={(e)=>{calcValonDpliqChange(e.target.value)}} value={dpliqval} />
                        </div>
                        <div>
